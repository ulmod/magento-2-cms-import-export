...
* Export unlimited number of CMS Pages into a CSV file
* Export CMS Pages including all related data such as status, content heading, content, metadata and more;
* Import any number of CMS Pages via a CSV file. Ability to excludes CMS Pages data/field during the export
* Support sample import CSV file right at the import settings
* Ability to import CMS Pages including all data
...
* Support export history, ability to manage all export log from the backend
* Ability to delete export logs/history manually or automatically
